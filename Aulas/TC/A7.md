...
<div id="TC7.1" class="mathbox-wrapper">
  <div class="mathbox">
    $$\color{blue}{\boldsymbol{\not dw = \vec F \cdot \vec {ds} = F_s ds}}$$
  </div>
