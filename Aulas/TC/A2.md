...
<div class="toolbox" id="esferas-tool"> <div class="toolbox-header">
  ...
  <div class="interactive-area">
    ...
    <div class="jsbox-control-panel">
      <div class="jsbox-controls-grid" style="grid-template-columns: 1fr 1.5fr auto; gap: 20px;">
        ...
        <div style="background: #fdfdfd; border-radius: 8px; border: 1px solid #eee; padding: 10px;">
          <div class="jsbox-col-title" style="color: #666; font-size: 0.9em; border-bottom: 1px solid #eee; margin-bottom: 5px;">Últimos Resultados</div>
        ...
        <div class="jsbox-vis-right">
          <div class="jsbox-card">
            <div class="jsbox-card-body" style="justify-content: center; height: 100%;">
              ...
              <div style="text-align: center; font-weight: bold; color: #ff9800; margin-bottom: 10px;">
                Média (80% finais): <span id="val-avg-freq">--</span> colisões/int
              </div>
